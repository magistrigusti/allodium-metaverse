    ...
    <div className="min-h-screen w-screen" id="about">
      <div className="relative mb-8 mt-36 flex flex-col items-center gap-5">
        <h2 className="font-general mb-8 text-sm uppercase md:text-[40px]">
          Welcome to <b>Dominum</b><span className="text-xs align-super">™</span>
        </h2>
        ...
        <div className="about-subtext">
          <p>MetadApp in telegramm on Ton blockchain</p>

          <p>Dominum invites players and investors to immrse themselves in the world of game fi</p>
        </div>
      </div>
